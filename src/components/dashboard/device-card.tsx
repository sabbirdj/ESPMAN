...
export function DeviceCard({ device, onSelect, onReboot }: DeviceCardProps) {
  ...
  return (
    <Card
      className={`group relative overflow-hidden border-neutral-200 bg-white transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-neutral-200/50 dark:border-neutral-800 dark:bg-neutral-950 dark:hover:shadow-black/40 ${
