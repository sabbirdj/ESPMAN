...
> **Important Setup Note:** After running this command, you must edit your `.env` file to add your Turso Database credentials. Once edited, run `bun run db:push` to sync the database schema, and then restart the PM2 services with `pm2 restart all`.
